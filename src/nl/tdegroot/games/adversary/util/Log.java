...
public final class Log {
    ...
    /** true if activated by the system property "nl.tdegroot.games.engine.forceVerboseLog" */
     ...
     * value must be "true"
     */
    private static final String forceVerboseProperty = "nl.tdegroot.games.engine.forceVerboseLog";
     ...
     *
     * @param message The message describing the infomation
     * @param endLine True if it should end the line after printing
     */
    public static void info(String message, boolean endLine) {
        if (verbose || forcedVerbose) {
            logSystem.info(message, endLine);
        }
    }
     ...
     * @param endLine True if it should end the line after printing
     */
    public static void debug(String message, boolean endLine) {
        if (verbose || forcedVerbose) {
            logSystem.debug(message, endLine);
        }
    }
}